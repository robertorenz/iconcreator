...
public static class Loc
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["hint.dropPlace"] = "Drop to place on the canvas  (hold Ctrl for a new vector tab)",
        ["hint.dropOpen"] = "Drop to open as a new tab",
        ["hint.dropVectorNew"] = "Drop to import into a new vector drawing",
        ["hint.dropVectorHere"] = "Drop to import into this drawing (resizable)",
        ["hint.dropNewTab"] = "Drop to open in a new tab (SVG → vector, image → icon)",
        ["msg.saved"] = "Saved {0}",
        ["msg.opened"] = "Opened {0}",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["hint.dropPlace"] = "Suelta para colocar en el lienzo  (mantén Ctrl para una pestaña vectorial nueva)",
        ["hint.dropOpen"] = "Suelta para abrir en una pestaña nueva",
        ["hint.dropVectorNew"] = "Suelta para importar en un dibujo vectorial nuevo",
        ["hint.dropVectorHere"] = "Suelta para importar en este dibujo (redimensionable)",
        ["hint.dropNewTab"] = "Suelta para abrir en una pestaña nueva (SVG → vectorial, imagen → icono)",
